    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=255, unique=True, validators=[django.core.validators.RegexValidator(regex='^([a-zA-Z0-9\\._-]{4,}[^\\s])@\\w{2,25}\\.\\w{2,15}(\\.\\w{2,15})?$')], verbose_name='email address')),
